...
######################################################
##
##  LIVE - will try to incorporate the Fox News Live script by Rooster
##
######################################################

    def foxNewsLive(self):
        # Constants
        ...
        # get items to form fileList for m3u
        getItems(url)
        ...
        def getItems(url):
            ...
            link = response.read()
            xbmc.log( "foxNewsLive: link=" + str(link))
        ...
        def doPolling(url):
            ...
            xbmc.log( "foxNewsLive: doPolling" )
            ...
            for name,url,desc,thumbnail,Year,Month,Day,Time in match:
                ...
                xbmc.log( "foxNewsLive: name=" + str(name))
                xbmc.log( "foxNewsLive: localTime=" + str(localTime))
                xbmc.log( "foxNewsLive: label=" + str(label))
                xbmc.log( "foxNewsLive: url=" + str(url))
                xbmc.log( "foxNewsLive: desc=" + str(desc))
                xbmc.log( "foxNewsLive: thumbnail=" + str(thumbnail))
                xbmc.log( "foxNewsLive: Year=" + str(Year))
                xbmc.log( "foxNewsLive: Month=" + str(Month))
                xbmc.log( "foxNewsLive: Day=" + str(Day))
                xbmc.log( "foxNewsLive: Time=" + str(Time))
                try:
            ...
            xbmc.log( "foxNewsLive: Added " + str( newCount ) + " new items to the playlist" )
